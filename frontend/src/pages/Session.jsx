...
const Session = ({ patients = [], onStartRecording, onUploadAudio }) => {
   ...
   const handleUploadButtonClick = () => {
    ...
    // FIX: Create a NEW session with the uploaded file
    const handleFileChange = async (event) => {
        ...
        try {
            ...
            formData.append("patient", selectedPatientId); // Backend expects "patient" ID
            formData.append("audio_file", file);           // Backend expects "audio_file"
            formData.append("status", "completed");        //  mark as completed since audio exists

            //  create a NEW session
            const response = await api.post("/therapy_sessions/", formData, {
                headers: { "Content-Type": "multipart/form-data" },
            });

            console.log("Session Created:", response.data);
            alert("Audio uploaded and session created successfully!");
